...
namespace WebApplication1.Controllers
{
    public class ArticlesController : Controller
    {
        ...
        //public async Task<IActionResult> Create([Bind("Id,Name,Price,CategoryId,ImagePath")] Article article)
        //{
        ...
        public async Task<IActionResult> Create(Article article, IFormFile? imageFile)
        {
            ...
            {
                // Ustawienie domyślnej ścieżki, jeśli użytkownik nie dodał obrazka
                article.ImagePath = "/upload/default.png";
            }
